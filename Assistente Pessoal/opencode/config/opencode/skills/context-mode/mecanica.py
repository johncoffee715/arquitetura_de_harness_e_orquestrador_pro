...
class Output(BaseModel):
    """Output estrito de context-mode — validado via Pydantic + GBNF"""
    ...
    skill: str = Field(default="context-mode", pattern=r"^[a-z0-9-]+$")
...
def constrained_generate(prompt: str, max_retries: int = 3) -> Output:
    ...
    sample = {"result": "ok-context-mode", "confidence": 0.95, "skill": "context-mode"}
...
if __name__ == "__main__":
    ...
    # test anti-lixo
    try:
        validate_json_str('{"result": "x", "confidence": 0.9, "skill": "context-mode", "extra": "lixo"}')
