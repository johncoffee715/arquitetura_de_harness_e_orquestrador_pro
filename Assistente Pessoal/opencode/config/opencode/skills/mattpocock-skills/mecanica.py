#!/usr/bin/env python3
"""
Mecanica — mattpocock-skills
R77 tríplice + R81 constrained decoding + R82 estrangulamento
Skill: mattpocock-skills — skills Matt Pocock
...
class Output(BaseModel):
    """Output estrito de mattpocock-skills — validado via Pydantic + GBNF"""
    ...
    skill: str = Field(default="mattpocock-skills", pattern=r"^[a-z0-9-]+$")
...
def constrained_generate(prompt: str, max_retries: int = 3) -> Output:
    ...
    sample = {"result": "ok-mattpocock-skills", "confidence": 0.95, "skill": "mattpocock-skills"}
...
if __name__ == "__main__":
    ...
    # test anti-lixo
    try:
        validate_json_str('{"result": "x", "confidence": 0.9, "skill": "mattpocock-skills", "extra": "lixo"}')
