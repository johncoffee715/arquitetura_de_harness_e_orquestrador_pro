...
Skill: coderabbit — code review AI
...
class Output(BaseModel):
    """Output estrito de coderabbit — validado via Pydantic + GBNF"""
    ...
    skill: str = Field(default="coderabbit", pattern=r"^[a-z0-9-]+$")
...
def constrained_generate(prompt: str, max_retries: int = 3) -> Output:
    ...
    sample = {"result": "ok-coderabbit", "confidence": 0.95, "skill": "coderabbit"}
...
if __name__ == "__main__":
    ...
    # test anti-lixo
    try:
        validate_json_str('{"result": "x", "confidence": 0.9, "skill": "coderabbit", "extra": "lixo"}')
