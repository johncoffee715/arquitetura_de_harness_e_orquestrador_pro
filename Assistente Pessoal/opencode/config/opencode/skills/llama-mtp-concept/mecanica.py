#!/usr/bin/env python3
"""
Mecanica — llama-mtp-concept
R77 tríplice + R81 constrained decoding + R82 estrangulamento
Skill: llama-mtp-concept — conceito MTP
...
class Output(BaseModel):
    """Output estrito de llama-mtp-concept — validado via Pydantic + GBNF"""
    ...
    skill: str = Field(default="llama-mtp-concept", pattern=r"^[a-z0-9-]+$")
...
def constrained_generate(prompt: str, max_retries: int = 3) -> Output:
    ...
    sample = {"result": "ok-llama-mtp-concept", "confidence": 0.95, "skill": "llama-mtp-concept"}
...
if __name__ == "__main__":
    ...
    # test anti-lixo
    try:
        validate_json_str('{"result": "x", "confidence": 0.9, "skill": "llama-mtp-concept", "extra": "lixo"}')
