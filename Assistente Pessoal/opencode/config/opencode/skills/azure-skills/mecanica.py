...
class Output(BaseModel):
    """Output estrito de azure-skills — validado via Pydantic + GBNF"""
    ...
    skill: str = Field(default="azure-skills", pattern=r"^[a-z0-9-]+$")
...
def constrained_generate(prompt: str, max_retries: int = 3) -> Output:
    ...
    sample = {"result": "ok-azure-skills", "confidence": 0.95, "skill": "azure-skills"}
...
if __name__ == "__main__":
    ...
    # test anti-lixo
    try:
        validate_json_str('{"result": "x", "confidence": 0.9, "skill": "azure-skills", "extra": "lixo"}')
