...
class Output(BaseModel):
    """Output estrito de ruview — validado via Pydantic + GBNF"""
    ...
    skill: str = Field(default="ruview", pattern=r"^[a-z0-9-]+$")
...
def constrained_generate(prompt: str, max_retries: int = 3) -> Output:
    ...
    sample = {"result": "ok-ruview", "confidence": 0.95, "skill": "ruview"}
...
if __name__ == "__main__":
    ...
    # test anti-lixo
    try:
        validate_json_str('{"result": "x", "confidence": 0.9, "skill": "ruview", "extra": "lixo"}')
