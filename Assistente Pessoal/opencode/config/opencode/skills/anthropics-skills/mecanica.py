#!/usr/bin/env python3
"""
Mecanica — anthropics-skills
R77 tríplice + R81 constrained decoding + R82 estrangulamento
Skill: anthropics-skills — skills Anthropics
...
class Output(BaseModel):
    """Output estrito de anthropics-skills — validado via Pydantic + GBNF"""
    ...
    skill: str = Field(default="anthropics-skills", pattern=r"^[a-z0-9-]+$")
...
def constrained_generate(prompt: str, max_retries: int = 3) -> Output:
    ...
    sample = {"result": "ok-anthropics-skills", "confidence": 0.95, "skill": "anthropics-skills"}
...
if __name__ == "__main__":
    ...
    # test anti-lixo
    try:
        validate_json_str('{"result": "x", "confidence": 0.9, "skill": "anthropics-skills", "extra": "lixo"}')
