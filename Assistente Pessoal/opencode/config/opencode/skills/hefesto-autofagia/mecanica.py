...
class Output(BaseModel):
    ...
    skill: str = Field(default="hefesto-autofagia", pattern=r"^[a-z0-9-]+$")
...
def constrained_generate(prompt: str, max_retries=3) -> Output:
    sample={"result":"ok-hefesto-autofagia","confidence":0.95,"skill":"hefesto-autofagia"}
