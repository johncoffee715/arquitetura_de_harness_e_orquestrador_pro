#!/usr/bin/env python3
"""
Mecanica — guardrail-llm-fitragem
...
class Output(BaseModel):
    ...
    skill: str = Field(default="guardrail-llm-fitragem", pattern=r"^[a-z0-9-]+$")
...
def constrained_generate(prompt: str, max_retries=3) -> Output:
    sample={"result":"ok-guardrail-llm-fitragem","confidence":0.95,"skill":"guardrail-llm-fitragem"}
