#!/usr/bin/env python3
"""
Mecanica — longhorizon-harness
R77 tríplice + R81 constrained decoding + R82 estrangulamento
Skill: longhorizon-harness — harness long horizon
...
class Output(BaseModel):
    """Output estrito de longhorizon-harness — validado via Pydantic + GBNF"""
    ...
    skill: str = Field(default="longhorizon-harness", pattern=r"^[a-z0-9-]+$")
...
def constrained_generate(prompt: str, max_retries: int = 3) -> Output:
    ...
    sample = {"result": "ok-longhorizon-harness", "confidence": 0.95, "skill": "longhorizon-harness"}
...
if __name__ == "__main__":
    ...
    # test anti-lixo
    try:
        validate_json_str('{"result": "x", "confidence": 0.9, "skill": "longhorizon-harness", "extra": "lixo"}')
