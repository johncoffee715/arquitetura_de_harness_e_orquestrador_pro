#!/usr/bin/env python3
"""
Mecanica — cc-harness-iai
R77 tríplice + R81 constrained decoding + R82 estrangulamento
Skill: cc-harness-iai — harness CC IAI
...
class Output(BaseModel):
    """Output estrito de cc-harness-iai — validado via Pydantic + GBNF"""
    ...
    skill: str = Field(default="cc-harness-iai", pattern=r"^[a-z0-9-]+$")
...
def constrained_generate(prompt: str, max_retries: int = 3) -> Output:
    ...
    sample = {"result": "ok-cc-harness-iai", "confidence": 0.95, "skill": "cc-harness-iai"}
...
if __name__ == "__main__":
    ...
    # test anti-lixo
    try:
        validate_json_str('{"result": "x", "confidence": 0.9, "skill": "cc-harness-iai", "extra": "lixo"}')
