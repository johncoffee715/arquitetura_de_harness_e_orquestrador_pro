#!/usr/bin/env python3
"""
Mecanica — agentic-awesome-skills
R77 tríplice + R81 constrained decoding + R82 estrangulamento
Skill: agentic-awesome-skills — catálogo de padrões agentic
...
class Output(BaseModel):
    """Output estrito de agentic-awesome-skills — validado via Pydantic + GBNF"""
    ...
    skill: str = Field(default="agentic-awesome-skills", pattern=r"^[a-z0-9-]+$")
...
def constrained_generate(prompt: str, max_retries: int = 3) -> Output:
    ...
    sample = {"result": "ok-agentic-awesome-skills", "confidence": 0.95, "skill": "agentic-awesome-skills"}
...
if __name__ == "__main__":
    ...
    # test anti-lixo
    try:
        validate_json_str('{"result": "x", "confidence": 0.9, "skill": "agentic-awesome-skills", "extra": "lixo"}')
