...
Skill: react-bits — React Bits
Origin: https://github.com/react-bits
...
class Output(BaseModel):
    """Output estrito de react-bits — validado via Pydantic + GBNF"""
    ...
    skill: str = Field(default="react-bits", pattern=r"^[a-z0-9-]+$")
...
def constrained_generate(prompt: str, max_retries: int = 3) -> Output:
    ...
    sample = {"result": "ok-react-bits", "confidence": 0.95, "skill": "react-bits"}
...
if __name__ == "__main__":
    ...
    # test anti-lixo
    try:
        validate_json_str('{"result": "x", "confidence": 0.9, "skill": "react-bits", "extra": "lixo"}')
