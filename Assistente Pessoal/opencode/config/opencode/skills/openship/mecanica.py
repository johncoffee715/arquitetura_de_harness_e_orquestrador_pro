...
class Output(BaseModel):
    """Output estrito de openship — validado via Pydantic + GBNF"""
    ...
    skill: str = Field(default="openship", pattern=r"^[a-z0-9-]+$")
...
def constrained_generate(prompt: str, max_retries: int = 3) -> Output:
    ...
    sample = {"result": "ok-openship", "confidence": 0.95, "skill": "openship"}
...
if __name__ == "__main__":
    ...
    # test anti-lixo
    try:
        validate_json_str('{"result": "x", "confidence": 0.9, "skill": "openship", "extra": "lixo"}')
