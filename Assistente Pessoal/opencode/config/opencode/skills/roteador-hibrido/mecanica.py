...
class Output(BaseModel):
    ...
    skill: str = Field(default="roteador-hibrido", pattern=r"^[a-z0-9-]+$")
...
def constrained_generate(prompt: str, max_retries=3) -> Output:
    sample={"result":"ok-roteador-hibrido","confidence":0.95,"skill":"roteador-hibrido"}
