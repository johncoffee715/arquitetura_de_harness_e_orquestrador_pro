#!/usr/bin/env python3
"""
Mecanica — worldmonitor
R77 tríplice + R81 constrained decoding + R82 estrangulamento
Skill: worldmonitor — dashboard inteligência global
...
class Output(BaseModel):
    """Output estrito de worldmonitor — validado via Pydantic + GBNF"""
    ...
    skill: str = Field(default="worldmonitor", pattern=r"^[a-z0-9-]+$")
...
def constrained_generate(prompt: str, max_retries: int = 3) -> Output:
    ...
    sample = {"result": "ok-worldmonitor", "confidence": 0.95, "skill": "worldmonitor"}
...
if __name__ == "__main__":
    ...
    # test anti-lixo
    try:
        validate_json_str('{"result": "x", "confidence": 0.9, "skill": "worldmonitor", "extra": "lixo"}')
