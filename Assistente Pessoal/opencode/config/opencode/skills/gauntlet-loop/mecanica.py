#!/usr/bin/env python3
"""
Mecanica — gauntlet-loop
R77 triplice + R81 constrained decoding
Origin: https://github.com/gauntlet-loop
"""
...
class Output(BaseModel):
    ...
    skill: str = Field(default="gauntlet-loop", pattern=r"^[a-z0-9-]+$")
...
def constrained_generate(prompt: str, max_retries=3) -> Output:
    sample={"result":"ok-gauntlet-loop","confidence":0.95,"skill":"gauntlet-loop"}
