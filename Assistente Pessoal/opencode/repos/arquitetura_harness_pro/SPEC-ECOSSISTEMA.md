...
`/mnt/dados/Assistente Pessoal/cerebro com IA/` — raw/ (imutável) · wiki/ (summaries, concepts, entities, evidence, log.md) · aprendizados/ · decisoes/ (R50, R51 registradas) · pipeline/ · cerebral.db
