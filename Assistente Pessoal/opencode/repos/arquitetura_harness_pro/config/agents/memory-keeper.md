...
metadata:
  ...
  version: 2.0.0
  author: Gran-Mestre
  obsidian_vault: "/mnt/dados/Assistente Pessoal/cerebro com IA/"
...
### Vault Location
```
/mnt/dados/Assistente Pessoal/cerebro com IA/
```
...
1. **Salvar memórias como notas Obsidian:**
   - Criar nota em `/mnt/dados/Assistente Pessoal/cerebro com IA/` com formato Markdown
