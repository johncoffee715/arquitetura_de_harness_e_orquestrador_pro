...
- **Raw sources** (`/mnt/dados/Assistente Pessoal/cerebro com IA/raw/`) = entrada imutável
- **Wiki** (`/mnt/dados/Assistente Pessoal/cerebro com IA/wiki/`) = síntese mantida por IA
