...
- Fluxo obrigatório:
  ...
  4. **Obsidian** — gravar aprendizado/ conhecimento em `/mnt/dados/Assistente Pessoal/cerebro com IA/` (wiki/, aprendizados/, conceitos, decisões), disponível ao scaffold do orquestrador e ao harness em geral.
...
- Vault: `/mnt/dados/Assistente Pessoal/cerebro com IA/` — alimentar com cada descoberta (memória é poder).
...
> Promulgadas pelo usuário — valem para TODA instância e TODO local. Texto canônico detalhado: `/mnt/dados/Assistente Pessoal/harness/global-rules.md`. Aqui: essência irredutível executável.
