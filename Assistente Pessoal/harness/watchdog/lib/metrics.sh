...
STATE="/mnt/dados/Assistente Pessoal/harness/watchdog/orchestrator-metrics.state"
OUT="/mnt/dados/Assistente Pessoal/harness/watchdog/orchestrator-metrics.jsonl"
NOW=$(date +%s.%N)
...
MODEL=$(python3 -c "import json;print(json.load(open('/mnt/dados/Assistente Pessoal/harness/watchdog/orchestrator-state.json')).get('modelo','?'))" 2>/dev/null)
