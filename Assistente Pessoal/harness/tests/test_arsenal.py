...
HARNESS_AUTOFAGIA = Path("/mnt/dados/Assistente Pessoal/harness/autofagia")
...
def test_cenario5_fresh_subprocess(env, monkeypatch):
    ...
    monkeypatch.setattr(arsenal, "INTEGRATION_PY", Path("/mnt/dados/Assistente Pessoal/harness/core/integration.py"))
    loader = arsenal.RegistryLoader(arsenal.REGISTRY_PATH, arsenal.AGENT_REGISTRY_PATH)
