...
VERSION = "1.0.0"
BASE = Path("/mnt/dados/Assistente Pessoal/programas de apoio/opencode")
...
HOOK_CMD = "python3 /mnt/dados/Assistente Pessoal/programas de apoio/opencode/config/opencode/hooks/sync-llm-stack.py"
