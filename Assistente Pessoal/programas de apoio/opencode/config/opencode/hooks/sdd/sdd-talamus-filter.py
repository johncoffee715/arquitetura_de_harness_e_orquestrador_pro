...
LOG_PATH = Path("/mnt/dados/Assistente Pessoal/programas de apoio/opencode/config/opencode/logs/sdd-hook.log")
KRONJOB_HOOK = Path("/mnt/dados/Assistente Pessoal/programas de apoio/opencode/config/opencode/hooks/kronjob-talamus-filter.py")
