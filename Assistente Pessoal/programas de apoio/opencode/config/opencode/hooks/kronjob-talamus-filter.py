...
INVENTORY_PATH = Path("/mnt/dados/Assistente Pessoal/programas de apoio/opencode/config/opencode/harness/llm-inventory.json")
LOG_PATH = Path("/tmp/opencode/kronjob-talamus.log")
PREFLIGHT_LOG = Path("/mnt/dados/Assistente Pessoal/programas de apoio/opencode/state/watcher/talamus-preflight.jsonl")
