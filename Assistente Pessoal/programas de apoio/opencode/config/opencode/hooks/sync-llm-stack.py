...
SYNC = "/mnt/dados/Assistente Pessoal/programas de apoio/opencode/scripts/sync-llm-stack.py"
LOG = Path("/mnt/dados/Assistente Pessoal/programas de apoio/opencode/state/watcher/sync-llm-stack.log")
MAX_DIV_TEXT = 1200
