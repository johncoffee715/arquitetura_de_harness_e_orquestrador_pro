...
class TestGabarito:
    def test_gabarito_valido(self):
        ...
        gp = Path("/mnt/dados/Assistente Pessoal/programas de apoio/opencode/config/opencode/skills/bibliotecario/gabarito.json")
    ...
    def test_tres_camadas(self):
        ...
        d = Path("/mnt/dados/Assistente Pessoal/programas de apoio/opencode/config/opencode/skills/bibliotecario")
...
class TestCLI:
    def test_rag_cli(self):
        ...
        r = subprocess.run(
            [sys.executable, "/mnt/dados/Assistente Pessoal/programas de apoio/opencode/config/opencode/scripts/bibliotecario_rag.py",
             "hefesto", "--top-n", "3"],
