...
MOTOR = "/mnt/dados/Assistente Pessoal/programas de apoio/opencode/config/opencode/scripts/hefesto_motor.py"
...
class TestValidateGabarito:
    ...
    def test_all_four_skills_have_valid_gabaritos(self):
        ...
        skills_dir = Path("/mnt/dados/Assistente Pessoal/programas de apoio/opencode/config/opencode/skills")
