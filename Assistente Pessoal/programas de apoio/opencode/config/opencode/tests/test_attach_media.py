...
ROOT = Path("/mnt/dados/Assistente Pessoal/programas de apoio/opencode/config/opencode")
...
class TestAttachMedia(unittest.TestCase):
    ...
    def test_command_existe(self):
        ...
        self.assertIn("/mnt/dados/Assistente Pessoal/programas de apoio/opencode/config/opencode/scripts/attach_media.py", t)
