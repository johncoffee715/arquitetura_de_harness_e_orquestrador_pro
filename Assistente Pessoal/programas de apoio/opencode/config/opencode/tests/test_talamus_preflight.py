...
BASE = Path("/mnt/dados/Assistente Pessoal/programas de apoio/opencode/config/opencode")
...
WATCHER = Path("/mnt/dados/Assistente Pessoal/programas de apoio/opencode/state/watcher")
