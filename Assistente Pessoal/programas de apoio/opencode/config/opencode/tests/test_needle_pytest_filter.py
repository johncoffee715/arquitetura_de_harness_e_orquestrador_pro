...
SCRIPT = "/mnt/dados/Assistente Pessoal/programas de apoio/opencode/config/opencode/scripts/needle_pytest_filter.py"
...
class TestGabarito:
    def test_skill_tres_camadas(self):
        d = Path("/mnt/dados/Assistente Pessoal/programas de apoio/opencode/config/opencode/skills/needle-pytest-filter")
