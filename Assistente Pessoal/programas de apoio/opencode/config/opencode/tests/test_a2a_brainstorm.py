...
class TestGabarito:
    def test_tres_camadas(self):
        ...
        d = Path("/mnt/dados/Assistente Pessoal/programas de apoio/opencode/config/opencode/skills/a2a-brainstorm")
    ...
    def test_gabarito_valido(self):
        ...
        g = json.loads(Path("/mnt/dados/Assistente Pessoal/programas de apoio/opencode/config/opencode/skills/a2a-brainstorm/gabarito.json").read_text())
