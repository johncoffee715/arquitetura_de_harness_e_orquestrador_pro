...
sys.path.insert(0, "/mnt/dados/Assistente Pessoal/programas de apoio/opencode/config/opencode/scripts")

from log_summarizer import summarise_log, compress_result, extract_tail

SCRIPT = "/mnt/dados/Assistente Pessoal/programas de apoio/opencode/config/opencode/scripts/log_summarizer.py"
...
class TestGabarito:
    def test_tres_camadas(self):
        d = Path("/mnt/dados/Assistente Pessoal/programas de apoio/opencode/config/opencode/skills/log-summarizer")
    ...
    def test_gabarito_valido(self):
        g = json.loads(Path("/mnt/dados/Assistente Pessoal/programas de apoio/opencode/config/opencode/skills/log-summarizer/gabarito.json").read_text())
