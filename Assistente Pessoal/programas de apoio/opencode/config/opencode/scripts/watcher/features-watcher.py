...
BASE_PATH = "/mnt/dados/Assistente Pessoal/programas de apoio/opencode/config/opencode"
STATE_PATH = "/mnt/dados/Assistente Pessoal/programas de apoio/opencode/state"
