...
CONFIG = Path("/mnt/dados/Assistente Pessoal/programas de apoio/opencode/config/opencode")
...
DECISION_LOG = Path("/mnt/dados/Assistente Pessoal/cerebro com IA/harness/decision-log.jsonl")  # canônico (Decisão A 2026-09-18)
