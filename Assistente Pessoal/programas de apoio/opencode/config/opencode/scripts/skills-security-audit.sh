...
SKILL_ROOTS=(
  "$HOME/.agents/skills"
  "/mnt/dados/Assistente Pessoal/programas de apoio/opencode/config/opencode/skills"
)
LOG_DIR="/mnt/dados/Assistente Pessoal/programas de apoio/opencode/config/opencode/logs"
