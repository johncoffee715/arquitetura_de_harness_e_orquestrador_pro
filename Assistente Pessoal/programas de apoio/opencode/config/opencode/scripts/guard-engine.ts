...
export const THIRD_PARTY_ROOTS: RegExp[] = [
  /^\/mnt\/dados\/Assistente Pessoal\/programas de apoio\/opencode\/(repos|cactus-build|llama\.cpp|cache)(\/|$)/,
...
export const HARNESS_OP_ROOTS: RegExp[] = [
  /^\/mnt\/dados\/Assistente Pessoal\/programas de apoio\/opencode\/(scripts|tools|tests|state|bin|templates|data)(\/|$)/,
]
