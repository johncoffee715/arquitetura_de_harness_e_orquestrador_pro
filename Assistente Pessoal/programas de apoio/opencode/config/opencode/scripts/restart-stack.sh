...
set -u
BIN="/mnt/dados/Assistente Pessoal/programas de apoio/opencode/llama.cpp/bin/llama-server"
MDL="/mnt/dados/Assistente Pessoal/modelos LLM"
QAD="/mnt/dados/Assistente Pessoal/modelos LLM/filtragem"
NDL="/mnt/dados/Assistente Pessoal/programas de apoio/opencode/tools/needle2/needle"
NDT="/mnt/dados/Assistente Pessoal/programas de apoio/opencode/tools/needle2"
CFG="/mnt/dados/Assistente Pessoal/programas de apoio/opencode/config/opencode/tools/needle2"
