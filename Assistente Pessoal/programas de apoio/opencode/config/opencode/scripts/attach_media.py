...
# 2026-09-18 (asr-20260918-001): paths permanentes — /tmp morreu na limpeza; rebuild CPU-only
# em "programas de apoio" (R102). Env override ATTACH_WHISPER_MODEL + which() preservados.
WHISPER_BIN = (
    shutil.which("whisper")
    or shutil.which("whisper-cli")
    or "/mnt/dados/Assistente Pessoal/programas de apoio/whisper.cpp/build/bin/whisper-cli"
)
WHISPER_MODEL = os.environ.get(
    "ATTACH_WHISPER_MODEL",
    "/mnt/dados/Assistente Pessoal/programas de apoio/whisper.cpp/models/ggml-base.bin",
)
