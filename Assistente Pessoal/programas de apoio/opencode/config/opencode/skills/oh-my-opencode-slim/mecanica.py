#!/usr/bin/env python3
"""
Mecanica — oh-my-opencode-slim
R77 tríplice + R81 constrained decoding + R82 estrangulamento
Skill: oh-my-opencode-slim — opencode slim
...
class Output(BaseModel):
    """Output estrito de oh-my-opencode-slim — validado via Pydantic + GBNF"""
    ...
    skill: str = Field(default="oh-my-opencode-slim", pattern=r"^[a-z0-9-]+$")
...
def constrained_generate(prompt: str, max_retries: int = 3) -> Output:
    ...
    sample = {"result": "ok-oh-my-opencode-slim", "confidence": 0.95, "skill": "oh-my-opencode-slim"}
...
if __name__ == "__main__":
    ...
    # test anti-lixo
    try:
        validate_json_str('{"result": "x", "confidence": 0.9, "skill": "oh-my-opencode-slim", "extra": "lixo"}')
