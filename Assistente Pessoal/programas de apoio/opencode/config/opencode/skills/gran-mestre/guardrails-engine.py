...
DECISION_LOG_PATH = Path("/mnt/dados/Assistente Pessoal/cerebro com IA/harness/decision-log.jsonl")  # canônico (Decisão A 2026-09-18)
VAULT_OBSIDIAN_PATH = Path("/mnt/dados/Assistente Pessoal/cerebro com IA/")
GLOBAL_CONFIG_PATH = Path("/mnt/dados/Assistente Pessoal/programas de apoio/opencode/config/opencode/")
...
def register_global(scaffold: Dict) -> Dict:
    """
    R2/R44: Registra scaffolding globalmente em /mnt/dados/Assistente Pessoal/programas de apoio/opencode/config/opencode/.
