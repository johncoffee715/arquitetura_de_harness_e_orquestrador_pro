...
class Output(BaseModel):
    """Output estrito de spec-kit — validado via Pydantic + GBNF"""
    ...
    skill: str = Field(default="spec-kit", pattern=r"^[a-z0-9-]+$")
...
def constrained_generate(prompt: str, max_retries: int = 3) -> Output:
    ...
    sample = {"result": "ok-spec-kit", "confidence": 0.95, "skill": "spec-kit"}
...
if __name__ == "__main__":
    ...
    # test anti-lixo
    try:
        validate_json_str('{"result": "x", "confidence": 0.9, "skill": "spec-kit", "extra": "lixo"}')
