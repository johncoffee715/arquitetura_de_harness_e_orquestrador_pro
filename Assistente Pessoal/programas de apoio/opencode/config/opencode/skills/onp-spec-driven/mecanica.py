#!/usr/bin/env python3
"""
Mecanica — onp-spec-driven
R77 tríplice + R81 constrained decoding + R82 estrangulamento
Skill: onp-spec-driven — spec-driven ONP
...
class Output(BaseModel):
    """Output estrito de onp-spec-driven — validado via Pydantic + GBNF"""
    ...
    skill: str = Field(default="onp-spec-driven", pattern=r"^[a-z0-9-]+$")
...
def constrained_generate(prompt: str, max_retries: int = 3) -> Output:
    ...
    sample = {"result": "ok-onp-spec-driven", "confidence": 0.95, "skill": "onp-spec-driven"}
...
if __name__ == "__main__":
    ...
    # test anti-lixo
    try:
        validate_json_str('{"result": "x", "confidence": 0.9, "skill": "onp-spec-driven", "extra": "lixo"}')
