#!/usr/bin/env python3
"""
Mecanica — book-to-skill
R77 tríplice + R81 constrained decoding + R82 estrangulamento
Skill: book-to-skill — livro para skill
...
class Output(BaseModel):
    """Output estrito de book-to-skill — validado via Pydantic + GBNF"""
    ...
    skill: str = Field(default="book-to-skill", pattern=r"^[a-z0-9-]+$")
...
def constrained_generate(prompt: str, max_retries: int = 3) -> Output:
    ...
    sample = {"result": "ok-book-to-skill", "confidence": 0.95, "skill": "book-to-skill"}
...
if __name__ == "__main__":
    ...
    # test anti-lixo
    try:
        validate_json_str('{"result": "x", "confidence": 0.9, "skill": "book-to-skill", "extra": "lixo"}')
