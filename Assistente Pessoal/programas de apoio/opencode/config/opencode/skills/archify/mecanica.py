...
Skill: archify — diagramas arquitetura HTML/SVG
...
class Output(BaseModel):
    """Output estrito de archify — validado via Pydantic + GBNF"""
    ...
    skill: str = Field(default="archify", pattern=r"^[a-z0-9-]+$")
...
def constrained_generate(prompt: str, max_retries: int = 3) -> Output:
    ...
    sample = {"result": "ok-archify", "confidence": 0.95, "skill": "archify"}
...
if __name__ == "__main__":
    ...
    # test anti-lixo
    try:
        validate_json_str('{"result": "x", "confidence": 0.9, "skill": "archify", "extra": "lixo"}')
