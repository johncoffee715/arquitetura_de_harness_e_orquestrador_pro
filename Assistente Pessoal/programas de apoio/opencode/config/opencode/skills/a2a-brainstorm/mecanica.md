...
|---|---|---|---|
| 🛠️ Propositor | `contrato-plano` | :9088 proposer | tool calling, velocidade, precisão de sintaxe |
| 🧠 Refutador | `refutacao` | :9090 Ternary-8B | 8B de profundidade conceitual, BFCL 73.9 |
| ⚖️ Árbitro | `refutador-agil` | :9085 judge-3B | treinado para pontuação emparelhada, temp 0.15 |
