...
class Output(BaseModel):
    ...
    skill: str = Field(default="hefesto-helenizacao", pattern=r"^[a-z0-9-]+$")
...
def constrained_generate(prompt: str, max_retries=3) -> Output:
    sample={"result":"ok-hefesto-helenizacao","confidence":0.95,"skill":"hefesto-helenizacao"}
