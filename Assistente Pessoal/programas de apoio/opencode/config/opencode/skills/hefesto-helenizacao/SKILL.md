...
Instalar em `/mnt/dados/Assistente Pessoal/programas de apoio/opencode/config/opencode/` — invocável de QUALQUER instância. Proibido deixar em sessão isolada, /tmp ou projeto local.
