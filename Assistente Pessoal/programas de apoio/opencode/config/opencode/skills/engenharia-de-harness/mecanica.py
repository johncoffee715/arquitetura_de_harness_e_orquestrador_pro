#!/usr/bin/env python3
"""
Mecanica — engenharia-de-harness
R77 tríplice + R81 constrained decoding
Origin: https://github.com/arquitetura-harness
"""
...
class Output(BaseModel):
    ...
    skill: str = Field(default="engenharia-de-harness", pattern=r"^[a-z0-9-]+$")
...
def constrained_generate(prompt: str, max_retries=3) -> Output:
    sample={"result":"ok-engenharia-de-harness","confidence":0.95,"skill":"engenharia-de-harness"}
