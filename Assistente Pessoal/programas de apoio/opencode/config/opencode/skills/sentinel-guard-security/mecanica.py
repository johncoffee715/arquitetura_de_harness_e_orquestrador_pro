#!/usr/bin/env python3
"""
Mecanica — sentinel-guard-security
...
class Output(BaseModel):
    ...
    skill: str = Field(default="sentinel-guard-security", pattern=r"^[a-z0-9-]+$")
...
def constrained_generate(prompt: str, max_retries=3) -> Output:
    sample={"result":"ok-sentinel-guard-security","confidence":0.95,"skill":"sentinel-guard-security"}
