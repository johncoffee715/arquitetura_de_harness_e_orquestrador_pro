#!/usr/bin/env python3
"""
Mecanica — last30days-skill
R77 tríplice + R81 constrained decoding + R82 estrangulamento
Skill: last30days-skill — pesquisa 30d multi-plataforma
...
class Output(BaseModel):
    """Output estrito de last30days-skill — validado via Pydantic + GBNF"""
    ...
    skill: str = Field(default="last30days-skill", pattern=r"^[a-z0-9-]+$")
...
def constrained_generate(prompt: str, max_retries: int = 3) -> Output:
    ...
    sample = {"result": "ok-last30days-skill", "confidence": 0.95, "skill": "last30days-skill"}
...
if __name__ == "__main__":
    ...
    # test anti-lixo
    try:
        validate_json_str('{"result": "x", "confidence": 0.9, "skill": "last30days-skill", "extra": "lixo"}')
