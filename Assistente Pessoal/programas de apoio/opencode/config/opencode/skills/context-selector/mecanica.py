...
class Output(BaseModel):
    ...
    skill: str = Field(default="context-selector", pattern=r"^[a-z0-9-]+$")
...
def constrained_generate(prompt: str, max_retries=3) -> Output:
    sample={"result":"ok-context-selector","confidence":0.95,"skill":"context-selector"}
