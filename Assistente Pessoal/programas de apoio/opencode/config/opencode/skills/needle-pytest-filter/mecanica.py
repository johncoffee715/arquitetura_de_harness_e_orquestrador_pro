...
class Output(BaseModel):
    ...
    skill: str = Field(default="needle-pytest-filter", pattern=r"^[a-z0-9-]+$")
...
def constrained_generate(prompt: str, max_retries=3) -> Output:
    sample={"result":"ok-needle-pytest-filter","confidence":0.95,"skill":"needle-pytest-filter"}
