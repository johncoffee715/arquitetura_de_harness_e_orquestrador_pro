#!/usr/bin/env python3
"""
Mecanica — harness-kronjob-guardrail
...
class Output(BaseModel):
    ...
    skill: str = Field(default="harness-kronjob-guardrail", pattern=r"^[a-z0-9-]+$")
...
def constrained_generate(prompt: str, max_retries=3) -> Output:
    sample={"result":"ok-harness-kronjob-guardrail","confidence":0.95,"skill":"harness-kronjob-guardrail"}
