#!/usr/bin/env python3
"""
Mecanica — code-review-graph
R77 tríplice + R81 constrained decoding + R82 estrangulamento
Skill: code-review-graph — grafo de review
...
class Output(BaseModel):
    """Output estrito de code-review-graph — validado via Pydantic + GBNF"""
    ...
    skill: str = Field(default="code-review-graph", pattern=r"^[a-z0-9-]+$")
...
def constrained_generate(prompt: str, max_retries: int = 3) -> Output:
    ...
    sample = {"result": "ok-code-review-graph", "confidence": 0.95, "skill": "code-review-graph"}
...
if __name__ == "__main__":
    ...
    # test anti-lixo
    try:
        validate_json_str('{"result": "x", "confidence": 0.9, "skill": "code-review-graph", "extra": "lixo"}')
