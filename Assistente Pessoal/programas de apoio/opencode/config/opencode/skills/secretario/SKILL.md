...
metadata:
  ...
  date: 2026-09-14
  author: Gran-Mestre
  motor: Qwen3-Embedding-0.6B :9094 + execucao deterministica local (+ Needle2 :9099 acelerador de acoes estruturais)
---
...
1. **CPU :9094** — canônico (política CPU-only 2026-09-18; GPU :9097 descontinuado).
