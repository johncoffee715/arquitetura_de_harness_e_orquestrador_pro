#!/usr/bin/env python3
"""
Mecanica — i-have-adhd
R77 tríplice + R81 constrained decoding + R82 estrangulamento
Skill: i-have-adhd — acessibilidade ADHD
...
class Output(BaseModel):
    """Output estrito de i-have-adhd — validado via Pydantic + GBNF"""
    ...
    skill: str = Field(default="i-have-adhd", pattern=r"^[a-z0-9-]+$")
...
def constrained_generate(prompt: str, max_retries: int = 3) -> Output:
    ...
    sample = {"result": "ok-i-have-adhd", "confidence": 0.95, "skill": "i-have-adhd"}
...
if __name__ == "__main__":
    ...
    # test anti-lixo
    try:
        validate_json_str('{"result": "x", "confidence": 0.9, "skill": "i-have-adhd", "extra": "lixo"}')
