...
O Gran-Mestre arquiva memória em um vault Obsidian em `/mnt/dados/Assistente Pessoal/cerebro com IA/`:
...
║  ├── Padrões descobertos                                      ║
║  └── Contexto de projeto                                      ║
║  Local: /mnt/dados/Assistente Pessoal/cerebro com IA/ (vault Obsidian)            ║
