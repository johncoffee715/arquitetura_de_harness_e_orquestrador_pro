...
Uso:
  python3 smoke.py --port 8090 --name qwen27b-iq2xxs [--base-url http://127.0.0.1]
                   [--watcher-jsonl /mnt/dados/Assistente Pessoal/harness/logs/llm-usage-8090.jsonl]
...
def main():
    ...
    if not args.watcher_jsonl:
        args.watcher_jsonl = f"/mnt/dados/Assistente Pessoal/harness/logs/llm-usage-{args.port}.jsonl"
