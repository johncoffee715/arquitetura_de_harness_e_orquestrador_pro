...
@/home/johncoffee/.config/opencode/gsd-core/references/agent-contracts.md
@/home/johncoffee/.config/opencode/gsd-core/references/context-budget.md
@/home/johncoffee/.config/opencode/gsd-core/references/gates.md
</required_reading>
...
- Executor agents omit extended deviation rule examples and checkpoint examples from inline prompt — load on-demand via @/home/johncoffee/.config/opencode/gsd-core/references/executor-examples.md
- Planner agents omit extended anti-pattern lists and specificity examples from inline prompt — load on-demand via @/home/johncoffee/.config/opencode/gsd-core/references/planner-antipatterns.md
...
```
Pure doc-only / config-only / test-only tasks return `is_behavior_adding=false` and are exempt. When the gate trips, Read `/home/johncoffee/.config/opencode/gsd-core/references/execute-mvp-tdd.md` for the exact halt report format.
</step>
...
2. For each plan (sequentially, ignoring wave grouping):
   ...
   c. **If "Execute":** Read and follow `/home/johncoffee/.config/opencode/gsd-core/workflows/execute-plan.md` **inline**
...
@/home/johncoffee/.config/opencode/gsd-core/references/execute-phase-wave-guard.md

@/home/johncoffee/.config/opencode/gsd-core/references/execute-phase-context-guard.md
   ...
   **Sequential dispatch for parallel execution (waves with 2+ agents):**
   ...
   Agent(
     ...
     prompt="
       ...
       @/home/johncoffee/.config/opencode/gsd-core/references/checkpoints.md
       @/home/johncoffee/.config/opencode/gsd-core/references/tdd.md
       @/home/johncoffee/.config/opencode/gsd-core/references/worktree-path-safety.md
       ${CONTEXT_WINDOW < 200000 ? '' : '@/home/johncoffee/.config/opencode/gsd-core/references/executor-examples.md'}
       </execution_context>
...
@/home/johncoffee/.config/opencode/gsd-core/references/execute-phase-between-wave-reset.md
...
Read and follow `/home/johncoffee/.config/opencode/gsd-core/workflows/transition.md`, passing through the `--auto` flag so it propagates to the next phase invocation.
