...
@/home/johncoffee/.config/opencode/gsd-core/references/git-integration.md
</required_reading>
...
See `/home/johncoffee/.config/opencode/gsd-core/references/tdd.md` for structure.
</tdd_plan_execution>
...
See /home/johncoffee/.config/opencode/gsd-core/references/checkpoints.md for details.
</step>
...
Create `{phase}-{plan}-SUMMARY.md` at `.planning/phases/XX-name/`. Use `/home/johncoffee/.config/opencode/gsd-core/templates/summary.md`.
