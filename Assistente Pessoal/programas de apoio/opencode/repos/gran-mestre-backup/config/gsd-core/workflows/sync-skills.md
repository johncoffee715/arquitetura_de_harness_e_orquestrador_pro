...
INSTALL_JS_GLOBAL="/home/johncoffee/.config/opencode/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/johncoffee/.config/opencode/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
