...
# ESTADOS COGNITIVOS — Taxonomia para Self-Learning

## Conceito Fundamental

> **O modelo não "pensa" — ele passa por estados cognitivos discretos.**
> Conhecer esses estados permite otimizar cada fase do pipeline para o estado certo.
