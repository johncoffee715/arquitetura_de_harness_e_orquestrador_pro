...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const moveSession = Effect.fn("MoveSession.moveSession")(function* (input: Input) {
      ...
      // CONTEXT.md: moving a session clears its active Context Epoch so the
      // destination initializes a complete baseline instead of inheriting the
      // source environment via incremental reconcile.
