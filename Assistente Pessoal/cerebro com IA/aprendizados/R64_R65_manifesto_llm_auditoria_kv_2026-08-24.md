...
## R68-b — A2A obrigatório (24/08 noite)
Evidência: qwen3.8-9b sintetizou design do DOOM64 SOLO (sem A2A/swarm/brainstorming) → subagentes lazy + spec rasa. Fix: A2A OBRIGATÓRIO (momus ≥2 rodadas + artistry alternativas) no AGENTS.md compacto como instrução operacional de toda sessão. /mix e /complex já tinham o loop nos templates — o gap era task direta sem comando.
