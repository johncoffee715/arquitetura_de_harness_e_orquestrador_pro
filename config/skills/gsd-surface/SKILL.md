...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/johncoffee/.config/opencode/.gsd-surface.json`
(sibling to `/home/johncoffee/.config/opencode/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/johncoffee/.config/opencode/skills/gsd-*/`.
...
(`~/.config/opencode`), NOT the skills sub-directory (`/home/johncoffee/.config/opencode/skills`).
...
`/home/johncoffee/.config/opencode/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/johncoffee/.config/opencode/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/johncoffee/.config/opencode/.gsd-surface.json`
Install profile marker: `/home/johncoffee/.config/opencode/.gsd-profile`
Skill dirs: `/home/johncoffee/.config/opencode/skills/gsd-*/`
Engine module: `/home/johncoffee/.config/opencode/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/johncoffee/.config/opencode/gsd-core/bin/lib/clusters.cjs`
</execution_context>
