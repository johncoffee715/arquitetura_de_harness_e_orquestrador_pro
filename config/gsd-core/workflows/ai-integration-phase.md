...
<required_reading>
@/home/johncoffee/.config/opencode/gsd-core/references/ai-frameworks.md
@/home/johncoffee/.config/opencode/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /home/johncoffee/.config/opencode/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/home/johncoffee/.config/opencode/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /home/johncoffee/.config/opencode/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /home/johncoffee/.config/opencode/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /home/johncoffee/.config/opencode/agents/gsd-eval-planner.md for instructions.
