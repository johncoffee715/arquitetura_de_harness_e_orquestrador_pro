...
Reference full template: `/home/johncoffee/.config/opencode/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/johncoffee/.config/opencode/gsd-core/templates/state.md`.
